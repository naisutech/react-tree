 ...
 * @public
 */
export declare type Leaf = Entry & {
    label: string;
};
/**
 * @public
 ...
 * @public
 */
export declare type Node = Entry & Leaf & {
    items?: LeafList;
};
/**
 * @public
 ...
 * @public
 */
export declare type ToggleFunction = typeof ToggleFunction;
/**
 * @public
 */
...
export declare type InternalTreeProps = Partial<TreeProps> & {
    currentTheme: string;
};
